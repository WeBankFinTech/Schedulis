...
public class ExecutionOptions {
    ...
    /**
     * 存放任务属性 auto.disabled 为 true 的任务
     */
    private List<Object> autoDisabledJobs = new ArrayList<>();
    ...
    public static ExecutionOptions createFromObject(final Object obj) {
        ...
        if (wrapper.containsKey(AUTO_DISABLED_JOBS)) {
            options.autoDisabledJobs = wrapper.getList(AUTO_DISABLED_JOBS);
        }
    ...
    public List<Object> getAutoDisabledJobs() {
        return autoDisabledJobs;
    }

    public void setAutoDisabledJobs(List<Object> autoDisabledJobs) {
        this.autoDisabledJobs = autoDisabledJobs;
    }
    ...
    public Map<String, Object> toObject() {
        ...
        flowOptionObj.put(AUTO_DISABLED_JOBS, this.autoDisabledJobs);
