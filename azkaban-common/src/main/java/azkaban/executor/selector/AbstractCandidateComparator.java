 ...
 * <pre>
 */
public abstract class AbstractCandidateComparator<T> implements Comparator<T> {

  protected static final Logger logger = LoggerFactory.getLogger(AbstractCandidateComparator.class);
