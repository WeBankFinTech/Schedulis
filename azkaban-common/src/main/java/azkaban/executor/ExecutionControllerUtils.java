...
public class ExecutionControllerUtils {
    ...
    private static List<String> setDutyGroup(SlaOption slaOption) {
        //有值班组，在这里修改告警人列表
        ...
        if (groupObj != null && StringUtils.isNotEmpty(groupObj.toString())) {
            DutyService dutyService = ServiceProvider.SERVICE_PROVIDER.getInstance(DutyServiceImpl.class);
