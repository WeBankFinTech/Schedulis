 ...
 */
public abstract class AbstractTimeBasedReportingMetric<T> extends AbstractMetric<T> {
   ...
   */
  public AbstractTimeBasedReportingMetric(final String metricName, final String metricType,
  ...
  private TimerTask getTimerTask() {
    final AbstractTimeBasedReportingMetric<T> lockObject = this;
