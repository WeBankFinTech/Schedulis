...
public class HadoopJobUtils {
    ...
    public static void killAllHadoopJobsSync(String logFilePath, Logger log)
        ...
        for (String appId : allSpawnedJobs) {
            killByCommandSync(String.format("yarn application -kill %s", appId), log);
        }
    }

    public static void killAllHadoopJobs(Set<String> appSet, Logger log)
            throws IOException, InterruptedException {
