...
public class DateUtils {
    ...
    public static String FORMATTER_Y_M_D = "yyyy-MM-dd";
    ...
    public static Boolean isBetweenDate(java.util.Date targetDate, java.util.Date startDate, java.util.Date endDate) {
        int compareStart = targetDate.compareTo(startDate);
        int compareEndTime = targetDate.compareTo(endDate);

        return compareStart >= 0 && compareEndTime <= 0;
    }
