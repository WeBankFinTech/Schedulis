...
public class SystemManager {
  ...
  public String getDepartmentAlarmReceiverByDepartment(String departmentName) {
    try {
      return this.systemUserLoader.getDepartmentAlarmReceiverByDepartment(departmentName);
    } catch (SQLException e) {
      logger.error("Exception in query department alarm receiver by department name, caused by: ",
          e);
    }
    return "";
  }
