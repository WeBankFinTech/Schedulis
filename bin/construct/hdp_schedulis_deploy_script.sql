...
-- wtssjobid-jobserverid-yarnid关联
CREATE TABLE `wtss_job_id_relation` (
    `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
    `exec_id` int(11) NOT NULL COMMENT '执行id',
    `attempt` int(11) NOT NULL COMMENT '重试次数',
    `job_id` varchar(512) CHARACTER SET latin1 NOT NULL COMMENT 'wtss_job_id',
    `job_server_job_id` varchar(256) DEFAULT NULL COMMENT 'job_server_job_id 多个已逗号隔开',
    `application_id` varchar(512) DEFAULT NULL COMMENT 'application_id 多个已逗号隔开',
    PRIMARY KEY (`id`),
