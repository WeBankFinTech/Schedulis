...
public class HadoopJobUtils {
   ...
   * @param log
   */
  public static void cancelHadoopTokens(AbstractHadoopSecurityManager hadoopSecurityManager,
   ...
   */
  public static AbstractHadoopSecurityManager loadHadoopSecurityManager(Props props, Logger log)
          throws RuntimeException {
    ...
    AbstractHadoopSecurityManager hadoopSecurityManager = null;

    try {
      Method getInstanceMethod = hadoopSecurityManagerClass.getMethod("getInstance", Props.class);
      hadoopSecurityManager = (AbstractHadoopSecurityManager) getInstanceMethod.invoke(
   ...
   */
  public static File getHadoopTokens(AbstractHadoopSecurityManager hadoopSecurityManager, Props props,
