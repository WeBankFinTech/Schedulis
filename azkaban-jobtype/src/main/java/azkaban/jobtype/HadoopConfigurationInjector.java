...
public class HadoopConfigurationInjector {
  private static Logger logger = LoggerFactory.getLogger(HadoopConfigurationInjector.class);
  ...
  public static void prepareResourcesToInject(Props props, String workingDir) {
    try {
      ...
      logger.error("Encountered error while preparing the Hadoop configuration resource file", e);
    }
  }
