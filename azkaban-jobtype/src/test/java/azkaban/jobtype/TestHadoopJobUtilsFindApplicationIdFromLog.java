...
public class TestHadoopJobUtilsFindApplicationIdFromLog {
  ...
  public void testLogWithMultipleApplicationIdsAppearingMultipleTimes() throws IOException {
    ...
    bw.write("28-08-2015 12:30:21 PDT Training_clickSelectFeatures INFO - INFO Closing idle connection Socket[addr=eat1-hcl5481.grid.linkedin.com/***REMOVED***,port=42492,localport=42382] to server eat1-hcl5481.grid.linkedin.com/***REMOVED***:42492\n");
    bw.write("28-08-2015 12:30:37 PDT Training_clickSelectFeatures INFO - INFO Closing idle connection Socket[addr=eat1-nertznn01.grid.linkedin.com/***REMOVED***,port=9000,localport=30453] to server eat1-nertznn01.grid.linkedin.com/***REMOVED***:9000\n");
