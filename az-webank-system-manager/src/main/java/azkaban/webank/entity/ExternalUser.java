...
/**
 * ExternalUser的JavaBean
 * Created by v_wbwpyin on 2017/5/19.
 */
...
//    manager_employee_number	int(10)	Lv0Leader - ID
    ...
    // 部分带参构造方法
    public ExternalUser(int appId, String userId, String urn, String fullName, String displayName, String title
