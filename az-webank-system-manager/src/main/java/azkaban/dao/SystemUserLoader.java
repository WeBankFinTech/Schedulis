...
public interface SystemUserLoader {
     ...
     *
     */
    List<WtssUser> findSystemUserPage(String preciseSearch, final String userName, final String fullName
    ...
    Map<Long, List<Integer>> getDepartmentExecutor(List<Long> dpId) throws SystemUserManagerException;
     ...
     * @throws SystemUserManagerException
     */
    List<WtssUser> getAllWtssUser() throws SystemUserManagerException;
     ...
     * @throws SystemUserManagerException
     */
    List<WtssRole> getAllWtssRole() throws SystemUserManagerException;

    /**
     * 获取所有的WtssPermissions
     * @return
     * @throws SystemUserManagerException
     */
    List<WtssPermissions> getAllWtssPermissions() throws SystemUserManagerException;
}
