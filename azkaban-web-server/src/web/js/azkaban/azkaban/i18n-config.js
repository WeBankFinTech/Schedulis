  ...
  var i18nObj = {
    "zh_CN": {
      ...
      "system": {
        ...
        "startDateMustBeforeEndDate": "开始日期不能大于结束日期",
        "mustSelectMember": "请选择成员",
        "keepAtLeastOneMember": "请至少添加一个成员",
        "viewEdit": "查看/编辑",
      },
      "param": {
      ...
      "view": {
        ...
        "reRunFlowShouldBeFailed": "批量重跑只能选择失败或停止的工作流",
      ...
      "deletePro": {
        ...
        "deleteDutyGroup": "删除值班组",
        "whetherDeleteDutyGroup": "是否删除该值班组？",
        "deleteUser": "删除用户",
    ...
    "en_US": {
      ...
      "system": {
        ...
        "startDateMustBeforeEndDate": "Start date must be earlier than end date",
        "mustSelectMember": "Please select member",
        "keepAtLeastOneMember": "Please keep at least one member",
        "viewEdit": "View/Edit",
      },
      "param": {
      ...
      "view": {
        ...
        "reRunFlowShouldBeFailed": "Batch rerun can only select failed or stopped workflows",
      ...
      "deletePro": {
        ...
        "deleteDutyGroup": "Delete duty group",
        "whetherDeleteDutyGroup": "Whether to delete the duty group?",
