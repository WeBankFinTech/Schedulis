...
azkaban.MergeJobBusinessView = Backbone.View.extend({
    ...
    handleMergeJobBusiness: function(evt) {
        ...
        if (!subsystem || !busResLvl || !planStartTime || !planFinishTime || !lastStartTime || !lastStartTime || !lastFinishTime || !scanPartitionNum|| !scanDataSize) {
...
azkaban.JobExecutionsView = Backbone.View.extend({
    ...
    render: function(evt) {
        ...
        for (var i = 0; i < executions.length; ++i) {
            ...
            //http://:8290/executor?execid=216859&job=subflow:sub1&attempt=0
    ...
    handlePageChange: function(evt) {
        ...
        // 获取单个参数
        const nestedId = urlParams.get('nestedId') || jobName;
