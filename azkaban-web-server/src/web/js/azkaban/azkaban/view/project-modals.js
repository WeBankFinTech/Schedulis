        ...
        $.ajax({
            ...
            success: function(data) {
                if (data["deleteProjectFlag"] == 1) {
                    ...
                    //判断是否有设置了定时调度
                    //http://:8290/manager?ajax=ajaxFetchProjectSchedules&project=child-flow-test2
...
azkaban.MergeProjectBusinessView = Backbone.View.extend({
    ...
    handleMergeProjectBusiness: function(evt) {
        ...
        if (!subsystem || !busResLvl || !planStartTime || !planFinishTime || !lastStartTime || !lastFinishTime || !devDept || !opsDept || !scanPartitionNum || !scanDataSize) {
