...
azkaban.ScheduleContextMenuView = Backbone.View.extend({
  events: {},
...
$(function () {
  scheduleContextMenuView = new azkaban.ScheduleContextMenuView({el: $('#contextMenu')});
  scheduleContextMenuView.hide();
});
