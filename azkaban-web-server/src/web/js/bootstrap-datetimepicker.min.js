!function(a) {
    ...
    var c = function(c, d) {
        var e, f, g, h, i, j, k, l = {}, m = !0, n = !1, o = !1, p = 0, q = [{
            ...
            o.find(".datepicker > div").hide().filter(".datepicker-" + q[k].clsName).attr("style", "display: block"))
        }, M = function() {
            var b = a("<tr>")
            ...
            (h.isSame(b({
                ...
                m += '<span data-action="selectDecade" style="width:72px;" class="decade' + (e.isAfter(h) && e.year() <= a ? " active" : "") + (R(h, "y") || k || l ? "" : " disabled") + '" data-selection="' + (h.year() + 6) + '">' + (h.year() + 1) + "-" + (h.year() + 12) + "</span>",
                h.add(12, "y");
